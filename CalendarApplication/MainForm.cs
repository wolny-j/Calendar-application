...
namespace Calendar
{
    ...
    public partial class MainForm : Form
    {
        ...
        {
            InitializeComponent();
            // The following call makes the panel used to display the calendar view
            // double-buffered.  This reduces the amount of flickering of the display.
            // This is a rather convoluted way of having to do it, but the alternative is
            // to create a class that inherits from Panel and set the DoubleBuffered property
            // in that to true. Do not change this call.
        ...
        private void panelDailyView_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            ...
            if (calendarEntry != null)
            {
                ...
                if (calendarEntry.DisplayText.Contains("Daily") || calendarEntry.DisplayText.Contains("Weekly") ||
               calendarEntry.DisplayText.Contains("Monthly") || calendarEntry.DisplayText.Contains("Yearly"))
                {
                    DateTime date = monthCalendar.SelectionRange.Start.Date;
                    ICalendarEntry Appointment = calendarEntry;
                    
                    RecurringApointmentForm recurringAppointmentForm = new RecurringApointmentForm();

                    recurringAppointmentForm._date = calendarEntry.Start.Date;
                    recurringAppointmentForm.Update();

                    if (recurringAppointmentForm.ShowDialog() == System.Windows.Forms.DialogResult.OK)
                    {
                        _calendarEntries.Remove(calendarEntry);
                        Appointment = recurringAppointmentForm.Appointment;
                        _calendarEntries.Add(Appointment);
                        SaveCalendarEntries();
                ...
                else
                {
                    ...
                    appointmentForm._date = calendarEntry.Start.Date;
                    appointmentForm.Update();

                    if (appointmentForm.ShowDialog() == System.Windows.Forms.DialogResult.OK)
                    {
                        _calendarEntries.Remove(calendarEntry);
        ...
        private void NewSingleEntry()
        {
            ...
            ICalendarEntry Appointment = new SingleAppointment();
            AppointmentForm appointmentForm = new AppointmentForm();
            appointmentForm._date = date;
            appointmentForm.Update();
        ...
        private void NewRecurringEntry()
        {
            ...
            //       calendar entry here.
            DateTime date = monthCalendar.SelectionRange.Start.Date;
            ICalendarEntry Appointment = new RecurringAppointment();
            RecurringApointmentForm recurringAppointmentForm = new RecurringApointmentForm();
            recurringAppointmentForm._date = date;
            recurringAppointmentForm.Update();
        ...
        private void editToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            //          here.
            if (_selectedCalendarEntry.DisplayText.Contains("Daily") || _selectedCalendarEntry.DisplayText.Contains("Weekly") ||
                _selectedCalendarEntry.DisplayText.Contains("Monthly") || _selectedCalendarEntry.DisplayText.Contains("Yearly"))
            {
                DateTime date = monthCalendar.SelectionRange.Start.Date;
                ICalendarEntry Appointment = _selectedCalendarEntry;
                _calendarEntries.Remove(_selectedCalendarEntry);
                RecurringApointmentForm recurringAppointmentForm = new RecurringApointmentForm();

                recurringAppointmentForm._date = _selectedCalendarEntry.Start.Date;
                recurringAppointmentForm.Update();
            ...
            else
            {
                ...
                appointmentForm._date = _selectedCalendarEntry.Start.Date;
                appointmentForm.Update();
        ...
        private void deleteToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            //          Raised by selecting Delete on the context menu
